...
export default function Home() {
  ...
  return <main className="site-shell">
    ...
    <section className="hero" aria-labelledby="hero-title"><div className="hero__copy"><p className="eyebrow"><Sparkles size={14} /> projetos Lovable prontos</p><h1 id="hero-title">Modele.<br />Venda.<br /><em>Escale.</em></h1><p className="hero__lead">Projetos Lovable prontos para você adaptar ao seu nicho, colocar sua marca e transformar em produto sem começar do zero.</p><a className="button button--primary" href="#projetos">Explorar projetos <ArrowDownRight size={18} /></a></div><div className="hero__stage" aria-hidden="true"><div className="hero__stage-art"><span className="hero__stage-index">01</span><div className="hero__stage-window"><span>Projeto Lovable</span><strong>Nova<br />oferta.</strong><i /></div><div className="hero__stage-card hero__stage-card--one"><span>MODELE</span></div><div className="hero__stage-card hero__stage-card--two"><span>ESCALE</span></div></div><div className="hero__stage-tag"><span>01</span> Base pronta. Sua visão.</div></div><div className="hero__ticker" aria-hidden="true"><span>PROJETOS PRONTOS PARA VIRAR NEGÓCIO</span><span>•</span><span>SEJA MEU SÓCIO</span><span>•</span><span>PROJETOS PRONTOS PARA VIRAR NEGÓCIO</span></div></section>
    ...
    <section className="manifesto" id="sobre"><div className="manifesto__rule" /><div><p className="eyebrow">Como funciona o Seja Meu Sócio</p><h2>Sem comissão.<br /><em>Sem pegadinha.</em></h2></div><div className="manifesto__copy"><p>Ao adquirir um projeto aqui, você recebe uma <strong>cópia completa</strong> de um produto já validado, otimizado e corrigido — pronto para modelar e vender como seu. Eu não ganho comissão sobre as suas vendas. O projeto é seu. Cada produto inclui um <strong>tutorial completo</strong> ensinando como personalizar, adaptar ao seu nicho e colocar no ar.</p><p style={{ marginTop: "12px" }}>Você não começa do zero. Você começa de um projeto que já funciona.</p><a href="#projetos">Explorar projetos <ArrowUpRight size={17} /></a></div></section>
    <section className="manifesto"><div className="manifesto__rule" /><div><p className="eyebrow">Projeto primeiro. Complexidade depois.</p><h2>Não comece<br /><em>do zero.</em></h2></div><div className="manifesto__copy"><p>Escolha uma base construída no Lovable, modele a experiência para o seu cliente e transforme sua adaptação em uma oferta. Você entra na parte que importa: posicionar, vender e escalar.</p><a href="#projetos">Ver projetos <ArrowUpRight size={17} /></a></div></section>
